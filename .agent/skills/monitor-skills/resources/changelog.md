...
## 2026-02-26
### Actualizados
- **sql-alchemy**: Incorporado flujo transaccional de Unit of Work (`flush()`), borrado con `delete()`, explicación sobre lazy loads y ajustes para relaciones Strict conformadas referenciando `back_populates` sin the legacy `backref`. (Basado en documentación de Quick Start y Relationship API oficial).
